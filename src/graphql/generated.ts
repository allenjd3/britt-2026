...
export type Category = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  ...
  pages?: Maybe<CategoryToPageConnection>;
...
export type CategoryPagesArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<CategoryToPageConnectionWhereArgs>;
};
...
/** Connection between the Category type and the page type */
export type CategoryToPageConnection = Connection & PageConnection & {
  __typename?: 'CategoryToPageConnection';
  /** Edges for the CategoryToPageConnection connection */
  edges: Array<CategoryToPageConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Page>;
  /** Information about pagination in a connection. */
  pageInfo: CategoryToPageConnectionPageInfo;
};

/** An edge in a connection */
export type CategoryToPageConnectionEdge = Edge & PageConnectionEdge & {
  __typename?: 'CategoryToPageConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Page;
...
/** Pagination metadata specific to &quot;CategoryToPageConnection&quot; collections. Provides cursors and flags for navigating through sets of CategoryToPageConnection Nodes. */
export type CategoryToPageConnectionPageInfo = PageConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'CategoryToPageConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the CategoryToPageConnection connection */
export type CategoryToPageConnectionWhereArgs = {
...
export type CreatePageInput = {
  ...
  authorId?: InputMaybe<Scalars['ID']['input']>;
  /** Set connections between the page and categories */
  categories?: InputMaybe<PageCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
...
export type PageCategoriesArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<PageToCategoryConnectionWhereArgs>;
};
...
/** Set relationships between the page to categories */
export type PageCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<PageCategoriesNodeInput>>>;
};

/** List of categories to connect the page to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type PageCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the category. If present, this will be used to connect to the page. If no existing category exists with this ID, no connection will be made. */
...
/** Connection between the Page type and the category type */
export type PageToCategoryConnection = CategoryConnection & Connection & {
  __typename?: 'PageToCategoryConnection';
  /** Edges for the PageToCategoryConnection connection */
  edges: Array<PageToCategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Category>;
  /** Information about pagination in a connection. */
  pageInfo: PageToCategoryConnectionPageInfo;
};

/** An edge in a connection */
export type PageToCategoryConnectionEdge = CategoryConnectionEdge & Edge & {
  __typename?: 'PageToCategoryConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Category;
...
/** Pagination metadata specific to &quot;PageToCategoryConnection&quot; collections. Provides cursors and flags for navigating through sets of PageToCategoryConnection Nodes. */
export type PageToCategoryConnectionPageInfo = CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'PageToCategoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the PageToCategoryConnection connection */
export type PageToCategoryConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Pagination metadata specific to &quot;PageToTagConnection&quot; collections. Provides cursors and flags for navigating through sets of PageToTagConnection Nodes. */
...
/** Pagination metadata specific to &quot;TagToPageConnection&quot; collections. Provides cursors and flags for navigating through sets of TagToPageConnection Nodes. */
...
export type GetPostsQuery = { __typename?: 'RootQuery', posts?: { __typename?: 'RootQueryToPostConnection', nodes: Array<{ __typename?: 'Post', id: string, title?: string | null, uri?: string | null, excerpt?: string | null, date?: string | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', altText?: string | null, mediaDetails?: { __typename?: 'MediaDetails', sizes?: Array<{ __typename?: 'MediaSize', sourceUrl?: string | null, name?: string | null } | null> | null } | null } } | null }>, pageInfo: { __typename?: 'RootQueryToPostConnectionPageInfo', hasNextPage: boolean, endCursor?: string | null } } | null };
